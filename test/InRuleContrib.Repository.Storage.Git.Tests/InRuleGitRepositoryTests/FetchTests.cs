...
namespace InRuleContrib.Repository.Storage.Git.Tests.InRuleGitRepositoryTests
{
    public class FetchTests : IDisposable
    {
        ...
        public void WithExistingRemoteWithNoCommits_ShouldDoSomething()
        {
            ...
            // Assert
            var originRef = _localFixture.Repository.Refs["refs/remotes/origin/master"];
        ...
        public void WithExistingRemoteWithOneCommit_ShouldMatchRefs()
        {
            ...
            Assert.Equal(_remoteFixture.Repository.Refs["refs/heads/master"].TargetIdentifier, originRef.TargetIdentifier);
        }
        ...
        public void WithExistingRemoteWithTwoBranches_ShouldMatchRefs()
        {
            ...
            // Assert
            var originMasterRef = _localFixture.Repository.Refs["refs/remotes/origin/master"];
            ...
            Assert.Equal(_remoteFixture.Repository.Refs["refs/heads/master"].TargetIdentifier, originMasterRef.TargetIdentifier);
