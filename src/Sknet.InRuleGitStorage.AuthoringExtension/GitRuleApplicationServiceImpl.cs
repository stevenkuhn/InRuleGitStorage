        ...
        try
        {
            ...
            waitWindow.DoWork += delegate
            {
                ...
                if (ruleAppDef.CatalogState != CatalogState.None)
                {
                    ...
                    {
                        if (def is RuleApplicationDef ruleApplicationDef)
                        {
                            ruleApplicationDef.SchemaCatalogState = CatalogState.None;
                            ruleApplicationDef.SchemaCatalogSharingState = CatalogSharingState.None;
                        }
